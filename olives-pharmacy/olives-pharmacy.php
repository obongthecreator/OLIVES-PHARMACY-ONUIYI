...
$html .= '<section class="olives-card p-4 mb-4"><div class="flex flex-col md:flex-row md:items-center gap-3 md:justify-between"><div class="relative w-full md:max-w-md"><iconify-icon icon="solar:magnifer-linear" class="absolute left-3 top-3 text-slate-400"></iconify-icon><input id="olives-stock-search" class="w-full pl-10 pr-3 py-2 rounded-[20px] border-slate-200" placeholder="Search products..." /></div><div class="flex gap-2"><button id="olives-add-product" class="px-4 py-2 rounded-[20px] bg-olives-green text-white">Add Product</button><button id="olives-export-products" class="px-4 py-2 rounded-[20px] border">Export CSV</button></div></div><div class="olives-table-wrap mt-4"><table class="w-full text-sm"><thead><tr class="text-left text-slate-500"><th class="p-2">Name</th><th class="p-2">NAFDAC</th><th class="p-2">Batch</th><th class="p-2">Expiry</th><th class="p-2">Qty</th><th class="p-2">Imported Today</th><th class="p-2">Cost</th><th class="p-2">Selling</th><th class="p-2">Reorder</th><th class="p-2">Actions</th></tr></thead><tbody id="olives-stock-tbody"></tbody></table></div></section>';
